                    ...
                    if (dayInfo[t][0] != null) {
                        ...
                        switch (temp) {
                            ...
                            case 0:
                                ...
                                dateImage.setImageResource(R.drawable.emoticon1);
                                break;
                            case 1:
                                Log.d(MainActivity.TAG, "(화면 2) 2");
                                dateImage.setImageResource(R.drawable.emoticon2);

                                break;
                            case 2:
                                Log.d(MainActivity.TAG, "(화면 2) 3");
                                dateImage.setImageResource(R.drawable.emotion_happy2);
    ...
    class CalendarNetwork extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String[] params) {
            ...
            try {
                ...
                Log.d(MainActivity.TAG, "error2 is " + e);
            }
            return null;
        }
