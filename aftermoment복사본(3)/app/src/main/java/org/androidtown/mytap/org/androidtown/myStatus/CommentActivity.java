...
public class CommentActivity extends Activity {
    ...
    public void storeStatus(int image, String comment) {
        ...
        myComment = comment;
        Log.d(MainActivity.TAG, "image is : " + myImage + " comment is " + myComment);
    ...
    class SendMyComment extends AsyncTask<String, Void, Void>
    {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                Log.v(MainActivity.TAG, "process code : " + code);
                switch(code){
                    case 200 :
                        Log.d(MainActivity.TAG, "Success data transmit");
                        break;
                    default :
                        Log.d(MainActivity.TAG, "Fail data transmit");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
