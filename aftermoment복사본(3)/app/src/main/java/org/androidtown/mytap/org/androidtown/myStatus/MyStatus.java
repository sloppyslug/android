...
public class MyStatus extends Fragment {
    ...
    public static final int[] emoticon =
            new int[]{R.drawable.emoticon1, R.drawable.emoticon2, R.drawable.emotion_happy2, R.drawable.emotion_angry, R.drawable.emotion_happy};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        pickerView.setOnSelectListener(new AbstractWheel.OnSelectListener() {
            ...
            public void onSelect(int position) {
                myImage=position;
                if(commentText.getText().toString().equals("오늘 기분은 어떠세요?")) {
                    Log.d(MainActivity.TAG, "(화면 1) 코멘트 없음");
                    comment = null;
                }else{
                    Log.d(MainActivity.TAG, "(화면 1) 코멘트 있음");
                    Log.d(MainActivity.TAG, "(화면 1) 코멘트 : " +commentText.getText().toString());
